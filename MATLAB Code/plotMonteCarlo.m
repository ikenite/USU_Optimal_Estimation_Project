...
ylabels = {'E Position Est Err (m)',...
    ...
    'q2 Attitude Est Err (unitless)',...
    'q3 Attitude Est Err (unitless)',...
    'q4 Attitude Est Err (unitless)',...
    ...
    'E Ground Coil Position Est Err (m)',...
    'N Ground Coil Position Est Err (m)',...
    'U Ground Coil Position Est Err (m)'};
for i=1:n
